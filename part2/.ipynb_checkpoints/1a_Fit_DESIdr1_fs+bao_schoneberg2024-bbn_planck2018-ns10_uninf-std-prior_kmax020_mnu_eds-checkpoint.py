...
chain_name = f'chains/MCMC-fs+bao_klim_0-0.02-{k_max}_2-0.02-{k_max}-{tracers_str}-GCcomb_schoneberg2024-bbn_planck2018-ns10_{prior_basis}-prior_{pt_model}_{model}_{kernels}'
if not set_emulator:
    chain_name += '_noemu'
#print(chain_name)
