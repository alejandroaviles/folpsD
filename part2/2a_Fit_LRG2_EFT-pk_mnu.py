...
chain_name= f'{base_dir}/Abacus2gen_chains/mnu/{tracers_str}_{model}_{"std" if prior_basis == "standard" else prior_basis}_kr{kr_max:.3f}_{pt_model}_{"Afull" if A_full_status else "Ano"}_hn'
