...
def get_cobaya_covmat(model='base', theory='camb', dataset='desi-bao-all', run='run3', base_dir=covmat_dir, get_parameterization=get_parameterization, get_cobaya_output=get_cobaya_output):
    ...
    if '-prior3' in dataset:
        ...
        return covmat
    if model == 'base':
        covmat = f'/global/cfs/cdirs/desicollab/science/cpe/y1kp7/fs/cobaya/camb/run3/base/desi-reptvelocileptors-fs-all_schoneberg2024-bbn_planck2018-ns10/chain.covmat'
    if model == 'base_mnu':
